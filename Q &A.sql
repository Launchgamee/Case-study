...
--5. FIND OUT THE EMPLOYEES WHO ARE NOT WORKING IN DEPARTMENT 10 OR 30.   
     ...
     select * 
	 from employee 
	 where departmentid <> 30 or departmentid <> 30

--6. LIST OUT THE EMPLOYEES WHOSE NAME STARTS WITH 'S'.      

      select * 
	  from employee 
	  where lastname like 's_%'
--7. LIST OUT THE EMPLOYEES WHOSE NAME STARTS WITH 'S' AND ENDS WITH   
--'H'.

   select * 
   from employee 
   where lastname like 's_%'and lastname like '%_h'

--8. LIST OUT THE EMPLOYEES WHOSE NAME LENGTH IS 4 AND START WITH 'S'.  -- [Paused here ]
      select * 
      from employee 
	  where 
...
--ORDER BY CLAUSE:
--1. LIST OUT THE EMPLOYEE ID, LAST NAME IN ASCENDING ORDER BASEON THE EMPLOYEE ID.
